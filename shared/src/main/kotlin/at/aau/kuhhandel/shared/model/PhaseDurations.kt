...
object PhaseDurations {
    const val PLAYER_CHOICE_MS = 30_000L
    const val AUCTION_BIDDING_MS = 5_000L
    const val AUCTIONEER_DECISION_MS = 15_000L
    const val AUCTION_PAYMENT_MS = 30_000L
    const val AUCTION_RESULT_MS = 5_000L
    const val TRADE_OFFER_MS = 30_000L
    const val TRADE_RESPONSE_MS = 30_000L
